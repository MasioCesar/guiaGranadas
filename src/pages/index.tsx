        ...
        >
            {({ errors, touched }) => (
                <Form className="p-6 w-full flex flex-col items-center justify-center h-[90vh]">
                    ...
                    <img src="/images/logoprataGlobal.png" alt="Logo Knife" className="mx-auto mb-4 mt-2" width="400" />
                    ...
                    <button type="submit" className="border-[#c4ab08] border text-[#c4ab08] py-2 px-4 rounded mx-auto block hover:bg-yellow-400 hover:text-black w-2/4">Login</button>
                    </div>
                </Form>
            )}
        </Formik>
